      ...
      <div className="max-w-2xl w-full space-y-8">
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <form action={deleteSnippet} className="flex-1 sm:flex-none">
              <button
                type="submit"
                className="w-full px-6 py-3 bg-red-600 text-white rounded-md hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition-colors duration-200 font-medium"
              >
                Delete Snippet
              </button>
            </form>
